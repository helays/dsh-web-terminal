...
function apply(ctx) {
  ...
  function createSession({ cols = 80, rows = 24, cwd, kind, shellPath, shellArgs } = {}) {
    ...
    async handler(req, res) {
      ...
      if (rest === "/sessions" && method === "POST") {
        ...
        const record = createSession({
          ...
          cwd: typeof body.cwd === "string" && body.cwd ? body.cwd : void 0,
          kind: typeof body.kind === "string" && body.kind ? body.kind : void 0,
          shellPath: typeof body.shellPath === "string" ? body.shellPath : void 0,
          shellArgs: Array.isArray(body.shellArgs) ? body.shellArgs.filter((v) => typeof v === "string") : void 0
        });
